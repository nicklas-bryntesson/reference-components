...
- [ADR-0006](../../../../docs/adr/0006-native-control-fallback-on-coarse-pointers.md) — the `data-input-mode` custom/display fallback (DateField is the reference)
- [ADR-0007](../../../../docs/adr/0007-popover-light-dismiss-never-refocuses-trigger.md) — the calendar's Escape-vs-outside-click close paths
