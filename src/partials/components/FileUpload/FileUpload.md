...
| `data-label-drop-zone` | string | Visible drop-zone hint text (default: "Drop files here"). JS injects it as an `aria-hidden` `[data-part="drop-label"]` span — the trigger button remains the accessible action |
