...
>
  <input class="native" data-part="native" type="month" aria-hidden="true" tabindex="-1"${inputAttrs} />
  <div class="overlay" data-part="overlay" aria-hidden="true">
    <div class="segments" data-part="segments" role="group">
    </div>
    <button class="trigger" data-part="trigger" type="button" aria-label="Open month picker" aria-expanded="false" aria-haspopup="dialog"${triggerAttrs}>
    ...
    <div class="rail" data-part="rail">
      <template data-template="monthfield-popup">
        <div class="popup" data-part="popup" role="dialog" aria-modal="true">
          <div class="year-month-picker WheelColumns" data-part="year-month-picker">
          ...
          <div class="footer" data-part="footer">
            <button class="footer-clear" data-part="footer-clear" type="button"></button>
            <button class="footer-now" data-part="footer-now" type="button"></button>
          </div>
...
const states: StateDefinition[] = [
  ...
  // ── Localization showcase (ADR-0011): month names + language ──
  { file: '_locale-en-gb', id: 'mf-locale-en-gb', label: 'Month (en-GB)', locale: 'en-GB', root: { 'data-value': '2026-06' }, input: { value: '2026-06' }, trigger: {} },
  { file: '_locale-sv-se', id: 'mf-locale-sv-se', label: 'Month (sv-SE)', locale: 'sv-SE', root: { 'data-value': '2026-06' }, input: { value: '2026-06' }, trigger: {} },
]
